...
export default function CutomerEditDetails({ onClose, customer_id, onSave }) {
	...
	const getsinglecustomer = async () => {
		try {
			if (customer_id) {
				const singleCustomer = await customersSingleApi(customer_id);
	...
	const formik = useFormik({
		...
		onSubmit: async (values, { setSubmitting }) => {
			try {
				const resp = await await UpdateCustomerSpecificApi({
					customer_id,
					...values,
				});
	...
	// console.log("formik in edit customer", formik.values);
	return (
		<>
