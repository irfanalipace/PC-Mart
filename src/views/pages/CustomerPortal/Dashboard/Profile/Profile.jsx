...
// import AddCircleOutlineOutlinedIcon from '@mui/icons-material/EditRounded';
...
const Profile = ({ customerDetails, customerId }) => {
  ...
  const upadteLoader = useSelector(
    (state) => state?.customer?.isLoading
  );
  console.log('upadteLoader' , upadteLoader)
