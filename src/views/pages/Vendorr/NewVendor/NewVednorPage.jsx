...
function NewVendorPage({ edit }) {
	...
	const scrollOnError = () => {
		...
		if (hasErrors || contactPersonError || fieldError) {
			document.querySelector('.imhere')?.scrollIntoView({ behavior: 'smooth' });
		}
	};
	...
	const isContactPersonValid = () => {
		const filterdArray = formik.errors?.vendor_contacts?.filter(
			contact => contact?.last_name || contact?.email
		);
				...
				<form onSubmit={formik.handleSubmit}>
					<ContainerPaper>
						<Box mb={5} sx={{ minHeight: '80vh' }}>
							<Box aria-label='vendor-details' className='imhere'>
								{/* Names  */}
							...
							<TabGlobalComponent tabLabels={tabLabels}>
								<Box label='OtherDetails' pb={5}>
									<OtherDetailsTab
										...
										// 		opening_balance: formik.values.opening_balance,
										// 		mode_of_payment: formik.values.mode_of_payment,
										// 		paymentTerms: formik.values.paymentTerms,
										// 		website: formik.values.website,
										// 		department: formik.values.department,
										// 		designation: formik.values.designation,
										// 		facebook_link: formik.values.facebook_link,
										// 		skype_name: formik.values.skype_name,
										// 		twitter_link: formik.values.twitter_link,
										// 	},
										// 	errors: {
										// 		currency: formik.values.currency,
										// 		opening_balance: formik.values.opening_balance,
								...
								<Box label='Address' pb={5}>
									<AddressTab
										...
										// 	values: {
										// 		vendor_billing_address:
										// 			formik.values.vendor_billing_address,
										// 		vendor_shipping_address:
										// 			formik.values.vendor_shipping_address,
										// 	},
										// 	errors: {
										// 		vendor_billing_address:
										// 			formik.errors.vendor_billing_address,
										// 		vendor_shipping_address:
										// 			formik.errors.vendor_shipping_address,
										// 	},
										// 	touched: {
										// 		vendor_billing_address:
										// 			formik.touched.vendor_billing_address,
										// 		vendor_shipping_address:
										// 			formik.touched.vendor_shipping_address,
										// 	},
										// }}
